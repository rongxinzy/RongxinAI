...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    llamacppWindowsVcRuntimeMissing: 'llama.cpp 需要 Microsoft Visual C++ Redistributable 才能在 Windows x64 上运行。请安装最新的 x64 版本后重试。{dll}',
    llamacppWindowsVcRuntimeMissingDll: ' 缺失 DLL：{dll}。',
  ...
  en: {
    ...
    llamacppWindowsVcRuntimeMissing: 'llama.cpp requires the Microsoft Visual C++ Redistributable to run on Windows x64. Install the latest x64 package and try again.{dll}',
    llamacppWindowsVcRuntimeMissingDll: ' Missing DLL: {dll}.',
