...
describe('llamacpp runtime installer planning', () => {
  ...
  test('plans an in-app download for packaged Windows users when runtime is missing', () => {
    ...
    expect(plan).toEqual({
      ...
      url: 'https://gitee.com/wanghaozhe1106/llama.cpp-runtime/releases/download/b9505/llama-b9505-bin-win-cpu-x64.tar.gz',
      fallbackUrls: [
  ...
  test('plans the fixed CUDA 12 runtime when preferred target id is set', () => {
    ...
    expect(plan).toEqual({
      ...
      runtimeRoot,
      executablePath: path.join(runtimeRoot, 'current', 'bin', 'llama-server.exe'),
      url: 'https://gitee.com/wanghaozhe1106/llama.cpp-runtime/releases/download/b9505/llama-b9505-bin-win-cuda-12.4-x64.tar.gz',
      fallbackUrls: [
      ...
      companionDownloads: [
        {
          ...
          url: 'https://gitee.com/wanghaozhe1106/llama.cpp-runtime/releases/download/b9505/cudart-llama-bin-win-cuda-12.4-x64.tar.gz',
          fallbackUrls: [
  ...
  test('resolves official runtime download URLs for packaged installs', () => {
    expect(resolveLlamaCppRuntimeDownloadUrl('mac-arm64')).toBe(
      'https://gitee.com/wanghaozhe1106/llama.cpp-runtime/releases/download/b9505/llama-b9505-bin-macos-arm64.tar.gz',
    );
