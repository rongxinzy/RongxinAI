...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    localInferenceServiceConfigGroupReasoning: '思考与模板',
    ...
    localInferenceServiceConfigReasoningLabel: 'Reasoning',
    localInferenceServiceConfigReasoningFormatLabel: 'Reasoning format',
    localInferenceServiceConfigReasoningBudgetLabel: 'Reasoning budget',
    ...
    localInferenceServiceConfigReasoningHint: '思考模型的 reasoning 开关；非 thinking 模型可设为 off 或 auto。',
    localInferenceServiceConfigReasoningFormatHint: '思考内容解析格式；DeepSeek/Qwen thinking 常用 deepseek。',
    localInferenceServiceConfigReasoningBudgetHint: '思考 token 预算；-1 不限制，0 立即结束思考，正数为预算。',
    ...
    marketplaceDescription: '浏览并安装 GGUF 模型',
    marketplaceSearch: '搜索',
    marketplaceSearchPlaceholder: '搜索模型，如 qwen3、deepseek-r1...',
    marketplaceSearchHint: '输入 owner/repo、模型名或能力关键词，例如 Qwen/Qwen3-8B-GGUF、reasoning、coder。',
    ...
    marketplaceFilterSizeSmall: '0-4B',
    marketplaceFilterSizeDesktop: '4B-8B',
    marketplaceFilterSizeWorkstation: '8B-32B',
    marketplaceFilterSizeLarge: '32B+',
    marketplaceFilterReset: '重置',
    marketplaceResultSummary: '已显示 {shown} / {total} 个模型',
    marketplacePageSummary: '第 {page} / {total} 页',
    marketplaceDataSourceHint: '来源：ModelScope GGUF 精选库，离线时使用本地精选兜底',
    ...
    localInferenceOptionDirectAnswerModeHint: '在标准模式与减少思考模式之间切换。',
    localInferenceOptionDirectAnswerModePanelHint: '在标准模式与减少思考模式之间切换。',
    ...
    localInferenceMetrics: '输入: {prompt} / 生成: {completion} / 总计: {total} / 速度: {speed} tokens/s',
    ...
    agentTabIM: 'IM 渠道',
    agentTabTriage: '路由',
    agentTriageOverride: '为此 Agent 自定义路由策略',
    agentTriageUseGlobal: '使用全局默认（关闭）',
    agentTriageUseGlobalHint: '所有 Agent 使用设置中模型页的全局自动路由配置',
    agentTriageCustomHint: '该 Agent 的自动路由将覆盖全局默认设置',
  ...
  en: {
    ...
    localInferenceServiceConfigGroupReasoning: 'Reasoning and templates',
    ...
    localInferenceServiceConfigReasoningHint: 'Reasoning switch for thinking models. Non-thinking models can use off or auto.',
    localInferenceServiceConfigReasoningFormatHint: 'Reasoning parser format. DeepSeek/Qwen thinking models usually use deepseek.',
    localInferenceServiceConfigReasoningBudgetHint: 'Thinking token budget. -1 is unlimited, 0 ends thinking immediately, positive values set a budget.',
    ...
    marketplaceDescription: 'Browse and install GGUF models',
    marketplaceSearch: 'Search',
    marketplaceSearchPlaceholder: 'Search models, e.g. qwen3, deepseek-r1...',
    marketplaceSearchHint: 'Search by owner/repo, model family, or capability, such as Qwen/Qwen3-8B-GGUF, reasoning, or coder.',
    ...
    marketplaceFilterButton: 'Filters',
    ...
    marketplaceDataSourceHint: 'Source: ModelScope GGUF curated list, with local curated fallback when offline',
    ...
    localInferenceOptionDirectAnswerModeHint: 'Switch between standard mode and reduced-thinking mode.',
    localInferenceOptionDirectAnswerModePanelHint: 'Switch between standard mode and reduced-thinking mode.',
    ...
    localInferenceMetrics: 'input: {prompt} / generated: {completion} / total: {total} / speed: {speed} tokens/s',
    ...
    agentTriageOverride: 'Customize routing for this Agent',
    agentTriageUseGlobal: 'Use global default (off)',
    agentTriageUseGlobalHint: 'All Agents use the global auto-routing config from Settings → Model',
    agentTriageCustomHint: 'This Agent\'s routing overrides the global defaults',
