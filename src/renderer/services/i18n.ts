...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    localInferenceInstall: '检查内置运行时',
    localInferenceRuntimeReady: 'llama.cpp 内置运行时已就绪。',
    localInferenceRuntimeMissing: '当前安装包缺少 llama.cpp 内置运行时，请重新安装完整安装包。',
    ...
    localInferenceThinkingModel: 'Thinking 模型',
    localInferenceNonThinkingModel: '普通模型',
    localInferenceThinkingModelHint: '按 reasoning_content / <think> 解析思考过程；默认不强制开启，由 llama.cpp 模板自动判断。',
    localInferenceNonThinkingModelHint: '不强制开启 thinking；普通模型通常忽略 reasoning 字段。',
    ...
    localInferenceOptionReasoningFormatLabel: '思考解析格式',
    localInferenceOptionReasoningFormatHint: '控制 llama.cpp 如何解析 thinking；auto 通常适合 DeepSeek-R1/Qwen 等模型。',
    localInferenceOptionThinkingForcedOpenLabel: 'Thinking 模式',
    localInferenceOptionThinkingForcedOpenHint: '请求模板开启或关闭 thinking；关闭时会同时把本次 thinking 预算设为 0，但不会把 reasoning 原样塞回正文。',
    localInferenceOptionThinkingBudgetTokensLabel: 'Thinking 最大 tokens',
    localInferenceOptionThinkingBudgetTokensHint: '发送为 thinking_budget_tokens；-1 使用服务默认，0 立即结束，正数限制本次思考长度。若服务已固定 reasoning-budget，则服务设置优先。',
  ...
  en: {
    ...
    localInferenceInstall: 'Check Bundled Runtime',
    localInferenceRuntimeReady: 'The bundled llama.cpp runtime is ready.',
    localInferenceRuntimeMissing: 'The current installer is missing the bundled llama.cpp runtime. Reinstall the full package.',
    ...
    localInferenceThinkingModel: 'Thinking model',
    localInferenceNonThinkingModel: 'Regular model',
    localInferenceThinkingModelHint: 'Reasoning is parsed from reasoning_content / <think>. By default llama.cpp decides from the chat template.',
    localInferenceNonThinkingModelHint: 'Thinking is not forced. Regular models usually ignore reasoning fields.',
    ...
    localInferenceOptionReasoningFormatLabel: 'Reasoning format',
    localInferenceOptionReasoningFormatHint: 'Controls how llama.cpp parses thinking. auto usually fits DeepSeek-R1/Qwen-style models.',
    localInferenceOptionThinkingForcedOpenLabel: 'Thinking mode',
    localInferenceOptionThinkingForcedOpenHint: 'Requests templates to enable or disable thinking. Disabled also sends a zero thinking budget without forcing raw reasoning text back into the main response.',
    localInferenceOptionThinkingBudgetTokensLabel: 'Max thinking tokens',
    localInferenceOptionThinkingBudgetTokensHint: 'Sent as thinking_budget_tokens. -1 uses the server default, 0 ends thinking immediately, and positive values limit this request. A fixed service reasoning-budget takes priority.',
