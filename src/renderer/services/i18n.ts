...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    localInferenceDownload: '下载 llama.cpp',
    localInferenceImportRuntime: '从本地导入...',
    localInferenceImportRuntimeTooltip: '选择本地已编译的 llama.cpp 目录，将其复制到 RongxinAI 管理的运行时目录中。适用于已自行下载编译或从其他渠道获取的 llama.cpp。',
    localInferenceImportRuntimeSuccess: 'llama.cpp 运行时导入成功。',
    localInferenceImportGuideTitle: 'llama.cpp安装',
    localInferenceImportGuideHelpTitle: '安装说明',
    localInferenceImportGuideDescription: '请确保所选目录包含完整的 llama.cpp 运行环境。以下是各操作系统的文件要求和推荐获取方式：',
    localInferenceImportGuideStep1: '下载对应平台的预编译包：',
    ...
    localInferenceImportGuideStep3: '点击「从本地导入...」，选择包含 llama-server 可执行文件的目录。',
    localInferenceImportGuideClose: '关闭',
    localInferenceImportGuideWindowsLoading: '正在读取 Windows 下载列表...',
    localInferenceImportGuideWindowsBuildTitle: '{version} {variant}',
    localInferenceImportGuideWindowsCpuLabel: 'CPU 版',
    localInferenceImportGuideWindowsCpuArm64Label: 'ARM64 CPU 版',
    localInferenceImportGuideWindowsCuda12Label: 'CUDA 12 版',
    localInferenceImportGuideWindowsCuda13Label: 'CUDA 13 版',
    localInferenceImportGuideWindowsRadeonLabel: 'Radeon 版',
    localInferenceImportGuideWindowsIntegratedLabel: '集成显卡版',
    localInferenceImportGuideWindowsGenericLabel: 'Windows 版',
    ...
    skillDownloadFailedNotFound: '未找到该技能，请检查技能链接或镜像同步情况。',
    skillDownloadFailedNetwork: '技能下载失败，网络或镜像连接异常。请稍后重试。',
    skillDownloadFailedAlreadyInstalled: '该技能已安装。如需覆盖安装，请先删除旧版本后重试。',
    skillDownloadFailedNpxUnavailable: '本地 Node.js / npx 不可用，无法安装技能。',
    skillDownloadFailedInvalidSource: '技能来源无效，请检查链接格式。',
  ...
  en: {
    ...
    localInferenceDownload: 'Download llama.cpp',
    localInferenceImportRuntime: 'Import from local...',
    localInferenceImportRuntimeTooltip: 'Select a locally built llama.cpp directory to copy into the RongxinAI-managed runtime directory. Use this if you have built or downloaded llama.cpp from another source.',
    ...
    localInferenceImportGuideTitle: 'llama.cpp Install',
    localInferenceImportGuideHelpTitle: 'Installation Guide',
    ...
    localInferenceImportGuideStep1: 'Download the prebuilt package for your platform:',
    localInferenceImportGuideStep1LinkLabel: 'ggml-org/llama.cpp Releases',
    localInferenceImportGuideStep1Url: 'https://github.com/ggml-org/llama.cpp/releases',
    localInferenceImportGuideStep2: 'Extract the downloaded archive',
    localInferenceImportGuideStep3: 'Click "Import from local..." and select the directory containing the llama-server executable.',
    localInferenceImportGuideClose: 'Close',
    localInferenceImportGuideWindowsLoading: 'Loading Windows downloads...',
    localInferenceImportGuideWindowsBuildTitle: '{version} {variant}',
    localInferenceImportGuideWindowsCpuLabel: 'CPU build',
    localInferenceImportGuideWindowsCpuArm64Label: 'ARM64 CPU build',
    localInferenceImportGuideWindowsCuda12Label: 'CUDA 12 build',
    localInferenceImportGuideWindowsCuda13Label: 'CUDA 13 build',
    localInferenceImportGuideWindowsRadeonLabel: 'Radeon build',
    localInferenceImportGuideWindowsIntegratedLabel: 'Integrated graphics build',
    localInferenceImportGuideWindowsGenericLabel: 'Windows build',
    ...
    skillDownloadFailedNotFound: 'Skill not found. Check the link or mirror sync status.',
    skillDownloadFailedNetwork: 'Skill download failed due to a network or mirror connectivity issue.',
    skillDownloadFailedAlreadyInstalled: 'This skill is already installed. Remove the existing version and try again.',
    skillDownloadFailedNpxUnavailable: 'Local Node.js / npx is unavailable, so the skill cannot be installed.',
    skillDownloadFailedInvalidSource: 'Invalid skill source. Please check the link format.',
