...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    localInferenceOptionThinkingForcedOpenHint: '控制支持 thinking 的模板是否启用思考；关闭时会同时把本次 thinking 预算设为 0。',
  ...
  en: {
    ...
    localInferenceOptionThinkingForcedOpenHint: 'Controls thinking for templates that support it. Disabled also sends a zero thinking budget for this request.',
