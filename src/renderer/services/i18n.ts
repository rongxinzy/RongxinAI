...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    marketplaceSearchStatusCatalogUnavailable: '云端模型目录不可用，当前显示的是本地精选',
    ...
    marketplaceDataSourceHint: '来源：云端 GGUF 目录；文件大小与 SHA-256 来自 ModelScope 仓库文件接口',
  ...
  en: {
    ...
    marketplaceSearchStatusCatalogUnavailable: 'Cloud model catalog unavailable; showing local recommendations',
    ...
    marketplaceResultCategory: 'Category results',
    ...
    marketplaceFitLimited: 'Lower settings',
    ...
    marketplaceInstalledNotIndexed: 'The model is installed but not indexed yet. Refresh and try again.',
