...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    localInferenceLocalModelsEmptyDescription: '前往模型市场安装 GGUF 模型，或将本地模型文件导入模型库后再刷新。',
  ...
  en: {
    ...
    localInferenceLocalModelsEmptyDescription: 'Install a GGUF model from the model marketplace, or import local model files into the library and refresh.',
