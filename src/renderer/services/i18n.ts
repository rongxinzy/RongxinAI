...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    localInferenceServiceConfigModelsMaxLabel: '最大模型数',
    ...
    localInferenceServiceConfigModelsMaxHint: '同时驻留内存的模型数量；桌面单模型建议填 1，多模型切换可填 2，留空使用默认值。',
  ...
  en: {
    ...
    localInferenceServiceConfigModelsMaxLabel: 'Max models',
    ...
    localInferenceServiceConfigModelsMaxHint: 'Number of models allowed to stay loaded at once. Use 1 for a desktop single-model setup, 2 for switching between models, or leave empty for the default.',
