...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    nimGuideStep1: '登录云信控制台或组织提供的管理后台',
    ...
    imNimQrLoginHint: '请使用已安装的云信 IM 客户端扫描二维码创建机器人；如未安装，请通过组织提供的安装渠道获取客户端。',
    imNimQrGenerating: '正在生成二维码...',
    imNimQrScanPrompt: '请使用已安装的云信 IM 客户端扫描下方二维码并完成绑定。',
  ...
  en: {
    ...
    nimGuideStep1: 'Log in to the NIM console or the admin portal provided by your organization',
    ...
    imNimQrLoginHint: 'Use an installed NIM client to scan the QR code and create a bot. If it is not installed, use the client installation channel provided by your organization.',
    imNimQrGenerating: 'Generating QR code...',
    imNimQrScanPrompt: 'Scan the QR code below with an installed NIM client to finish binding.',
