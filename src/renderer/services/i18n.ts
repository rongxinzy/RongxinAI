...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    chatSkillPlaceholderDeepResearch: '描述你的问题，生成深度研究报告',
  ...
  en: {
    ...
    mcpFeishuSubtitle: 'Connect Feishu through its official CLI to use calendars, documents, Bitable, chat, and more.',
    mcpConfigureTitle: 'Configure {name}',
    mcpGithubConfigureSubtitle: 'Connect GitHub to access the repositories, issues, and pull requests you authorize.',
    mcpGithubPat: 'GitHub personal access token',
    mcpGithubPatPlaceholder: 'github_pat_...',
    mcpGithubPatHint: 'Create a fine-grained token and grant only the repositories and permissions you need.',
    ...
    mcpBaiduAccessTokenHint: 'Enterprise verification, an app, and user authorization are required on the Baidu Netdisk Open Platform.',
    ...
    mcpTimeoutHint: 'Maximum wait time for connection, tool discovery, and tool calls. Range: 1-600 seconds.',
