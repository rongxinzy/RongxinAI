...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    localInferenceServiceConfigCacheRamHint: 'KV 缓存 RAM 上限，单位 MiB；0 禁用，留空使用默认值。',
    ...
    localInferenceImportGuideStep3: '点击「从本地导入...」，选择包含 llama-server 可执行文件的目录（通常为解压后的 bin/ 目录）',
  ...
  en: {
    ...
    localInferenceServiceConfigCacheRamHint: 'KV cache RAM limit in MiB. 0 disables it; leave empty to use the default.',
    ...
    localInferenceImportGuideStep3: 'Click "Import from local..." and select the directory containing the llama-server executable (usually the bin/ folder)',
