...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    agentLlamaCppContextInsufficientHint: '当前 llama.cpp 模型暂不可用于此任务，请调整上下文后重新加载，或改用其他模型',
  ...
  en: {
    ...
    agentLlamaCppContextInsufficientHint: 'This llama.cpp model is currently unavailable for this task. Reload it with a larger context, or switch to another model.',
