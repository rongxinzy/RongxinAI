...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    localInferenceInstallOpened: '已开始安装 llama.cpp 运行时，完成后请回到这里刷新状态。',
  ...
  en: {
    ...
    localInferenceInstallOpened: 'Started installing the llama.cpp runtime. Refresh here after installation.',
