...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    localInferenceInspectorOverview: '模型参数',
    localInferenceInspectorLogs: '执行日志',
    ...
    localInferenceModelLaunchLogWindowDescription: '展示本地推理模型的原始运行日志，用于排查问题。',
    ...
    aboutOpenDevTools: '打开开发者工具',
    aboutDevToolsHint: '也可使用 F12 或 Ctrl+Shift+I',
    testMode: '测试模式',
    theme: '主题',
    themeStyle: '界面风格',
    appearanceMode: '明暗模式',
    ...
    fetchModelsAuthFailed: 'API Key 无效或已过期',
    fetchModelsEndpointNotFound: '模型列表接口不存在，请检查 API Base URL',
    fetchModelsTimeout: '模型列表接口响应超时',
    ...
    modelConnectionTestSummary:
      '已测试 {total} 个模型：{success} 个连接成功，{failure} 个未通过连接测试',
    modelConnectionTestSuccessSummary: '{success} 个模型连接成功',
    modelConnectionTestAllFailed: '{total} 个模型全部未通过连接测试',
    modelConnectionTestProgress: '正在测试模型 {tested}/{total}…',
    modelConnectionTestBatchFailed: '测试模型连接时出错，请稍后重试',
    ...
    codingGitCreateBranchDescription:
      '新分支将基于当前提交创建并立即切换。任务运行期间会继续在新分支写入文件。',
    ...
    myAgentSidebarMinuteShort: '分钟前',
    myAgentSidebarHourShort: '小时前',
    myAgentSidebarDayShort: '天前',
    myAgentSidebarWeekShort: '周前',
    myAgentSidebarMonthShort: '月前',
    myAgentSidebarYearShort: '年前',
    agentPin: '置顶',
    agentUnpin: '取消置顶',
    ...
    createProjectNamePlaceholder: '请输入项目名称',
    ...
    skillMarketplaceSearchEmptyDescription:
      '已加载的技能中没有匹配项，清除搜索后可翻页浏览全部技能。',
    ...
    todoTitleRequired: '请先填写任务标题',
    todoDueDateMustBeFuture: '截止日期不能早于今天',
    todoReminderMustBeFuture: '提醒时间必须晚于当前时间',
    todoReminderMustBeforeDue: '提醒时间必须早于截止日期',
    todoUnseenBadge: '有新任务',
  ...
  en: {
    ...
    localInferenceInspectorOverview: 'Model Parameters',
    localInferenceInspectorLogs: 'Execution Logs',
    ...
    aboutOpenDevTools: 'Open Developer Tools',
    aboutDevToolsHint: 'Or press F12 / Ctrl+Shift+I',
    testMode: 'Test Mode',
    theme: 'Theme',
    ...
    fetchModelsAuthFailed: 'The API key is invalid or expired',
    fetchModelsEndpointNotFound: 'The model endpoint does not exist. Check the API Base URL',
    fetchModelsTimeout: 'The model endpoint timed out',
    ...
    fetchModelsFailed: 'Could not fetch the model list',
    ...
    modelConnectionTestSummary:
      'Tested {total} models: {success} connected successfully, {failure} did not pass the connection test',
    modelConnectionTestSuccessSummary: '{success} models connected successfully',
    modelConnectionTestAllFailed: '{total} models did not pass the connection test',
    modelConnectionTestProgress: 'Testing models {tested}/{total}…',
    modelConnectionTestBatchFailed: 'Testing model connections failed. Try again later.',
    ...
    chatSubmitEmptyHint: 'Please enter your question',
    ...
    createProjectNamePlaceholder: 'Enter a project name',
    projectPathLabel: 'Project Location',
    projectPathRequired: 'Please select a project location',
    ...
    skillInstalledEmptyDescription:
      'Install one from the marketplace, or import a local skill package.',
    skillInstalledNoMatchDescription: 'No skill matches the current category or search.',
    skillFilterClear: 'Clear filters',
    skillMarketplaceSearchEmptyDescription:
      'No match in the loaded skills. Clear the search to browse all pages.',
    ...
    todoTitleRequired: 'Enter a task title first',
    todoDueDateMustBeFuture: 'Due date cannot be before today',
    todoReminderMustBeFuture: 'Reminder must be later than now',
    todoReminderMustBeforeDue: 'Reminder must be before the due date',
    todoUnseenBadge: 'New tasks',
