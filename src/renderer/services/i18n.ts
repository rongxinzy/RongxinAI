...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    localInferenceServiceConfigTitle: 'llama.cpp 服务设置',
    ...
    localInferenceServiceConfigDeviceHint: '限制 llama.cpp 可见设备；支持填写 0、1 这类索引或设备名，多个值用逗号分隔，留空默认全部可见。',
    ...
    localInferenceServiceConfigCacheReuseHint: 'KV 缓存复用最小 chunk 大小；常见桌面值 256。',
    localInferenceServiceConfigCacheRamHint: 'KV 缓存 RAM 上限，单位 MiB；0 禁用，-1 不限制。',
    ...
    localInferenceServiceConfigTensorSplitHint: '多 GPU 张量拆分比例，例如 3,2；通常只在 split-mode 为 tensor 时使用。',
    ...
    localInferenceBackendConfigTitle: 'llama.cpp 配置',
    ...
    localInferenceNoModels: '暂无本地模型，请先安装一个模型。',
    ...
    localInferenceOptionDirectAnswerModeLabel: '回答模式',
    localInferenceOptionDirectAnswerModeHint: '通过附加系统提示词来引导更直接的回答风格，不是 llama.cpp 的硬参数开关。',
    localInferenceOptionDirectAnswerModePanelHint: '通过附加系统提示词来引导更直接的回答风格，不是 llama.cpp 的硬参数开关。',
    localInferenceDirectAnswerModeStandard: '标准模式',
    localInferenceDirectAnswerModeReducedThinking: '减少思考模式',
    ...
    localInferenceLaunchGpuPresetDescription: '配置 llama.cpp 的设备选择和多卡拆分方式。精确指定设备时必须使用 llama.cpp --list-devices 显示的设备名。',
    localInferenceLaunchGpuServiceDefault: '跟随服务设置',
    localInferenceLaunchGpuServiceDefaultHint: '不改动当前 llama.cpp 服务参数。',
    localInferenceLaunchGpuSingleAuto: '单卡优先',
    localInferenceLaunchGpuSingleAutoHint: '不指定 device，并使用 split-mode=none，由 llama.cpp 选择可用设备。',
    ...
    localInferenceLaunchGpuDualHint: '不指定 device，并使用 split-mode=layer，让 llama.cpp 在可用 GPU 间按层拆分。',
    localInferenceLaunchGpuCustom: '自定义',
    localInferenceLaunchGpuCustomHint: '手动填写 llama.cpp 设备名。',
    localInferenceLaunchGpuCustomValue: 'llama.cpp 设备名',
    localInferenceLaunchGpuCustomValueHint: '填写 --list-devices 输出的设备名，多个用逗号分隔；纯数字索引不是有效的 llama.cpp device。',
  ...
  en: {
    ...
    localInferenceServiceConfigDeviceHint: 'Limit visible llama.cpp devices. You can enter indexes like 0 or 1, separate multiple values with commas, or use device names from --list-devices directly. Leave empty to keep all devices visible.',
    ...
    localInferenceServiceConfigCacheReuseHint: 'Minimum KV cache reuse chunk size. 256 is a common desktop value.',
    localInferenceServiceConfigCacheRamHint: 'KV cache RAM limit in MiB. 0 disables it; -1 means no limit.',
    ...
    localInferenceNoModels: 'No local models yet. Install a model first.',
    ...
    localInferenceOptionDirectAnswerModeLabel: 'Response mode',
    localInferenceOptionDirectAnswerModeHint: 'Adds a system hint to encourage shorter, more direct replies. This is not a llama.cpp hard parameter toggle.',
    localInferenceOptionDirectAnswerModePanelHint: 'Adds a system hint to encourage shorter, more direct replies. This is not a llama.cpp hard parameter toggle.',
    localInferenceDirectAnswerModeStandard: 'Standard',
    localInferenceDirectAnswerModeReducedThinking: 'Reduced thinking',
    ...
    localInferenceThinkingInProgress: 'Thought for a moment',
    ...
    localInferenceMetricsSpeed: 'speed: {speed} tokens/s',
    ...
    localInferenceLaunchGpuPresetDescription: 'Configure llama.cpp device selection and multi-GPU split mode. Device names from --list-devices are supported, and numeric indexes like 0 or 1 are mapped automatically.',
    ...
    localInferenceLaunchGpuSingleAuto: 'Single-GPU first',
    localInferenceLaunchGpuSingleAutoHint: 'Leave device unset and use split-mode=none so llama.cpp chooses an available device.',
    ...
    localInferenceLaunchGpuDualHint: 'Leave device unset and use split-mode=layer so llama.cpp splits layers across available GPUs.',
    localInferenceLaunchGpuCustom: 'Custom',
    localInferenceLaunchGpuCustomHint: 'Manually set llama.cpp device names.',
    localInferenceLaunchGpuCustomValue: 'llama.cpp devices',
    localInferenceLaunchGpuCustomValueHint: 'Use numeric indexes like 0 or 1, or device names from --list-devices. Separate multiple values with commas. Leave empty to keep all devices visible.',
