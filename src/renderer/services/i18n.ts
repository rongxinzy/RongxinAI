...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    ollamaProviderServiceConnected: '服务已连接',
    ollamaProviderServiceExternal: '外部运行中',
    ollamaProviderServiceStarting: '服务启动中',
    ollamaProviderServiceStopped: '服务未运行',
    ollamaProviderConfigOnlyTitle: '这里仅启用 Ollama 提供商配置',
    ollamaProviderConfigOnlyDescription: '本开关不会启动或停止本机 Ollama 服务。服务启动、停止、模型加载和启动参数请在本地推理页面管理。',
    ollamaProviderOpenLocalInference: '前往本地推理',
    addModel: '添加模型',
    editModel: '编辑模型',
    addNewModel: '添加新模型',
    modelName: '模型名称',
  ...
  en: {
    ...
    ollamaProviderServiceConnected: 'Service connected',
    ollamaProviderServiceExternal: 'External process',
    ollamaProviderServiceStarting: 'Starting service',
    ollamaProviderServiceStopped: 'Service stopped',
    ollamaProviderConfigOnlyTitle: 'This only enables the Ollama provider configuration',
    ollamaProviderConfigOnlyDescription: 'This switch does not start or stop the local Ollama service. Manage service start, stop, model loading, and startup parameters from Local Inference.',
    ollamaProviderOpenLocalInference: 'Open Local Inference',
    addModel: 'Add Model',
