...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    marketplaceInstalledNext: '已安装，下一步',
    marketplaceRun: '立即运行',
    ...
    managedMemoryDescription: '查看个人与项目记忆的来源、生命周期和删除传播状态。',
    managedMemoryLoadFailed: '加载长期记忆失败',
    managedMemoryActionFailed: '记忆操作失败',
    managedMemoryRetryFailed: '重试删除传播失败',
    managedMemoryRetryPending: '重试待传播项（{count}）',
    managedMemoryEmptyTitle: '暂无受控记忆',
    managedMemoryEmptyDescription: '明确保存的项目记忆和待确认的个人记忆会显示在这里。',
    ...
    managedMemorySource: '来源：{id}',
    managedMemoryConfirm: '确认保存',
    managedMemoryConfirmed: '个人记忆已确认',
    ...
    workbenchTaskAcceptanceCardDescription: '没有可用的确定性验证结果，请确认最终成果是否符合预期后再决定。',
  ...
  en: {
    ...
    marketplaceInstalledNext: 'Installed · next step',
    marketplaceRun: 'Run now',
    ...
    managedMemoryDescription:
      'Review personal and project memory sources, lifecycle, and deletion propagation.',
    managedMemoryLoadFailed: 'Failed to load long-term memory',
    managedMemoryActionFailed: 'Memory action failed',
    managedMemoryRetryFailed: 'Failed to retry deletion propagation',
    ...
    managedMemoryEmptyDescription:
      'Explicit project memories and personal memories awaiting confirmation appear here.',
    ...
    managedMemoryScopeProject: 'Project',
    ...
    managedMemorySource: 'Source: {id}',
    managedMemoryConfirm: 'Confirm',
    managedMemoryConfirmed: 'Personal memory confirmed',
    ...
    workbenchTaskAcceptanceCardDescription: 'No deterministic verification is available for this result. Please confirm it matches your expectation before deciding.',
