...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    codingAgentCollaborate: '协作',
    codingAgentAddCollaborator: '添加协作者：',
    codingAgentHandoffTo: '交接给：',
    ...
    codingAgentManageAgentsDescription: '添加命令后需先明确确认信任，再手动探测 ACP 能力。',
    ...
    codingAgentProbeAgent: '探测 ACP',
    codingAgentAuthenticate: '登录',
    codingAgentPermission: '需要操作许可',
    codingAgentPermissionDescription:
      '外部 Agent 请求在当前工作区执行一项操作。请选择明确的处理方式。',
    codingAgentCancelPermission: '取消本次操作',
    codingAgentApprovePermission: '允许本次操作',
    codingAgentHandoffConfirmTitle: '确认交接',
    codingAgentHandoffConfirmDescription:
      '将当前 Lane 的持久化事件摘要交给目标 Agent，并切换到该 Lane。',
    codingAgentHandoffPreview: '交接包预览',
    ...
    codingAgentRecoveryDescription: '已创建新的 Agent 会话。请选择是否把下方恢复摘要与原始请求一同发送。',
    codingAgentRecoveryStartFresh: '不带摘要开始',
    codingAgentRecoverySendSummary: '发送恢复摘要',
    codingAgentConflictTitle: '协作改动与当前工作区冲突',
    codingAgentConflictDescription: '未应用任何改动。请先处理当前工作区改动，再重新查看并应用该 Lane 的差异。',
    ...
    codingAgentPresetTitle: '实现 → 审查 → 验证',
    codingAgentPresetDescription: '创建隔离的审查和验证 Lane；交接与应用仍需明确确认。',
    codingAgentPresetReviewer: '审查 Agent',
    codingAgentPresetVerifier: '验证 Agent',
    codingAgentPresetCreate: '创建协作预设',
    codingAgentHandoffCancel: '取消',
    codingAgentHandoffConfirm: '生成并交接',
  ...
  en: {
    ...
    codingAgentCollaborate: 'Collaborate',
    codingAgentAddCollaborator: 'Add collaborator:',
    codingAgentHandoffTo: 'Handoff to:',
    ...
    codingAgentManageAgentsDescription:
      'Added commands require explicit trust before a manual ACP probe.',
    ...
    codingAgentProbeAgent: 'Probe ACP',
    codingAgentAuthenticate: 'Sign in',
    codingAgentPermission: 'Action permission required',
    codingAgentPermissionDescription:
      'The external agent requested an operation in this workspace. Choose an explicit action.',
    codingAgentCancelPermission: 'Cancel this action',
    codingAgentApprovePermission: 'Allow this action',
    codingAgentHandoffConfirmTitle: 'Confirm handoff',
    codingAgentHandoffConfirmDescription:
      'Send the current lane’s persisted event summary to the target agent, then switch to that lane.',
    codingAgentHandoffPreview: 'Handoff package preview',
    ...
    codingAgentPresetTitle: 'Implement → Review → Verify',
    codingAgentPresetDescription:
      'Creates isolated review and verification lanes. Handoffs and applying changes still require explicit confirmation.',
    codingAgentPresetReviewer: 'Review agent',
    codingAgentPresetVerifier: 'Verification agent',
    codingAgentPresetCreate: 'Create collaboration preset',
    codingAgentHandoffCancel: 'Cancel',
    codingAgentHandoffConfirm: 'Generate and hand off',
