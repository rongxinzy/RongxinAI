...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    localInferenceLaunchGpuDevices: '模型使用 GPU',
    localInferenceLaunchGpuDevicesHint: '声明本次模型加载前 Ollama 服务可见的 GPU；变更后会自动重启服务再加载模型。',
    localInferenceLaunchGpuServiceDefault: '跟随服务默认',
    localInferenceLaunchGpuAuto: '自动选择',
    localInferenceLaunchGpu0: '仅 GPU 0',
    localInferenceLaunchGpu1: '仅 GPU 1',
    localInferenceLaunchGpu01: 'GPU 0 + GPU 1',
    localInferenceLaunchGpuCustom: '自定义',
    localInferenceLaunchGpuCustomValue: '自定义 GPU 序号',
    localInferenceLaunchGpuCustomHint: '填写 CUDA_VISIBLE_DEVICES 格式，例如 0,1。',
    localInferenceLaunchGpuCurrent: '当前服务可见 GPU：{devices}',
    localInferenceLaunchGpuCurrentAuto: '当前服务使用 Ollama 默认 GPU 选择。',
    localInferenceLaunchGpuWillUse: '将使用 GPU：{devices}',
    localInferenceLaunchGpuWillUseAuto: '将清空限制，交给 Ollama 自动选择 GPU。',
    localInferenceLaunchGpuRestartNotice: '该选择会重启 Ollama 服务，并卸载当前已加载模型。',
    localInferenceLaunchRestartFailed: 'Ollama 重启后未进入运行状态',
  ...
  en: {
    ...
    localInferenceLaunchGpuDevices: 'Model GPU Devices',
    localInferenceLaunchGpuDevicesHint:
      'Declare which GPUs are visible to Ollama before this model loads. Changes restart Ollama before loading the model.',
    localInferenceLaunchGpuServiceDefault: 'Follow service default',
    localInferenceLaunchGpuAuto: 'Auto select',
    localInferenceLaunchGpu0: 'GPU 0 only',
    localInferenceLaunchGpu1: 'GPU 1 only',
    localInferenceLaunchGpu01: 'GPU 0 + GPU 1',
    localInferenceLaunchGpuCustom: 'Custom',
    localInferenceLaunchGpuCustomValue: 'Custom GPU IDs',
    localInferenceLaunchGpuCustomHint: 'Use CUDA_VISIBLE_DEVICES format, for example 0,1.',
    localInferenceLaunchGpuCurrent: 'Current service-visible GPUs: {devices}',
    localInferenceLaunchGpuCurrentAuto: 'Current service uses Ollama default GPU selection.',
    localInferenceLaunchGpuWillUse: 'Will use GPUs: {devices}',
    localInferenceLaunchGpuWillUseAuto: 'Will clear GPU restrictions and let Ollama auto-select GPUs.',
    localInferenceLaunchGpuRestartNotice: 'This selection restarts Ollama and unloads currently loaded models.',
    localInferenceLaunchRestartFailed: 'Ollama did not enter the running state after restart',
