...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    localInferenceInspectorConfiguredContext: '已配置上下文',
    ...
    localInferenceInspectorLogsDescription: '查看此模型最近一次启动产生的原始日志。',
    localInferenceInspectorOpenLogs: '打开原始日志',
    ...
    codingGitPullRequestCreated: 'Pull Request 创建成功，正在打开浏览器。',
    ...
    codingGitCreateBranch: '创建并检出新分支…',
    codingGitCreateBranchTitle: '创建并检出新分支',
    codingGitCreateBranchDescription: '新分支将基于当前分支创建并立即切换。',
    ...
    codingAgentPermissionToolName: '工具名称',
    codingAgentPermissionToolInput: '工具参数',
    codingAgentPermissionToolDescription: '以下为外部 Agent 提交的操作内容，请仔细确认。',
  ...
  en: {
    ...
    localInferenceInspectorConfiguredContext: 'Configured Context',
    ...
    codingAgentCommands: 'Agent commands',
    ...
    codingGitPullRequestCreated: 'Pull request created successfully. Opening it in your browser.',
    ...
    codingGitCreateBranch: 'Create and switch to new branch…',
    codingGitCreateBranchTitle: 'Create and switch to a new branch',
    codingGitCreateBranchDescription: 'The new branch will be created from and switch to the current branch.',
    ...
    codingAgentPermissionToolName: 'Tool name',
    codingAgentPermissionToolInput: 'Tool input',
    codingAgentPermissionToolDescription:
      'The following operation was submitted by the external agent. Review it carefully.',
