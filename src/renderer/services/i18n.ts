...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    localInferenceServiceConfigDescription: '这些值会作为 llama.cpp 启动参数写入，只在启动或重启服务时生效。',
  ...
  en: {
    ...
    localInferenceServiceConfigDescription: 'These values are written as llama.cpp startup parameters and apply only after starting or restarting the service.',
