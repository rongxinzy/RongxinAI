...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    localInferenceServiceConfigDeviceHint: '限制 llama.cpp 可见设备；必须使用 --list-devices 显示的设备名，留空使用自动选择。',
    ...
    localInferenceServiceConfigTimeoutHint: 'HTTP 读写超时时间，单位秒；长上下文和慢模型建议调大。',
  ...
  en: {
    ...
    localInferenceServiceConfigDeviceHint: 'Limit visible llama.cpp devices. Use names from --list-devices; leave empty for automatic selection.',
    ...
    localInferenceServiceConfigTimeoutHint: 'HTTP read/write timeout in seconds. Increase for long context or slow models.',
    ...
    localInferenceLaunchGpuPresetDescription: 'Configure llama.cpp device selection and multi-GPU split mode. Exact device selection must use names shown by llama.cpp --list-devices.',
    ...
    localInferenceLaunchGpuCustomValueHint: 'Use device names from --list-devices, comma-separated. Numeric indexes alone are not valid llama.cpp device values.',
