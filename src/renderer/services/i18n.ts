...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    customBaseUrlHint: '填写模型服务地址，可带 /v1',
    customApiKeyHint: '如果服务无需鉴权，可留空',
    customDisplayName: '提供商名称',
    customDisplayNamePlaceholder: '例如：硅云',
    customDisplayNameHint: '不填写时将显示为“用户自定义”',
    customApiFormatHint: '本地 OpenAI 兼容服务通常选择 OpenAI',
    customModelSectionHint: '系统会尝试读取 /v1/models 或兼容的模型列表接口。',
  ...
  en: {
    ...
    customBaseUrlHint: 'Enter the model service address. /v1 is allowed.',
    customApiKeyHint: 'Leave empty if the service does not require authentication.',
    customDisplayName: 'Provider Name',
    customDisplayNamePlaceholder: 'e.g. SiliconFlow',
    customDisplayNameHint: 'If left empty, it will display as “Custom Provider”.',
    customApiFormatHint: 'OpenAI is usually the right choice for local OpenAI-compatible services.',
    customModelSectionHint: 'The system will try /v1/models or a compatible model list endpoint.',
    ...
    imFeishuGuideStep1: 'Click “Open Feishu Configuration Link” above to open the Feishu Open Platform.',
    imFeishuGuideStep2: 'Click “Create Now” next to “Create Feishu Intelligent Agent App” at the top of the page to create the app.',
    imFeishuGuideStep3: 'After creation, copy the App ID and App Secret, enter them below, and click “Test Connection”.',
