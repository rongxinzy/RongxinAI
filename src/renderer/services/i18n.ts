...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    agentNameDuplicate: '该 Agent 名称已存在，请修改后重试',
    agentNameReserved: '不能使用「主 Agent」作为 Agent 名称',
  ...
  en: {
    ...
    agentNameDuplicate: 'This agent name already exists. Please use a different name.',
    agentNameReserved: "Cannot use 'Primary Agent' as the agent name.",
