...
export const MARKETPLACE_MIN_PAGE_SIZE = 6;
export const MARKETPLACE_PAGE_SIZE_HEIGHT_BREAKPOINT = 820;
export const MARKETPLACE_WIDE_PAGE_SIZE = 16;
export const MARKETPLACE_WIDE_PAGE_SIZE_HEIGHT_BREAKPOINT = 900;
export const MARKETPLACE_EXTRA_TALL_PAGE_SIZE = 24;
export const MARKETPLACE_EXTRA_TALL_PAGE_SIZE_HEIGHT_BREAKPOINT = 960;
export const MARKETPLACE_WIDE_VIEWPORT_WIDTH_BREAKPOINT = 1_536;
