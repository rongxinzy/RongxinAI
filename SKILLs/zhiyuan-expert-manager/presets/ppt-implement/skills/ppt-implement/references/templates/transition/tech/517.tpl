<!-- Template: 科技风-扫描线 (Transition #517) -->
    ...
    <div class="w-[1350px] h-[720px] mx-auto my-[45px] relative">
        ...
        <div class="relative z-10 flex items-center justify-center h-full">
            <div class="text-center">
                <div class="text-5xl font-bold text-cyan-500 mb-4 font-mono">
                    <span class="inline-block border-2 border-cyan-500 px-6 py-3">&lt; 01 /&gt;</span>
                </div>
